function calcdeltaicsindex(measdir, output)
...
for k=1:size(lista1,1)
 ...
 ttt=0;
  ...
  save([output 'ics' lista1(k,1:end-1)],'fa_st', 'fa_qt', 'fa_qd', 'fa_tp', 'fa_ta');
  save([output 'delta_indexes' lista1(k,1:end-1)],'delt_st', 'delt_qt', 'delt_qd', 'delt_tp', 'delt_ta')
end
end
